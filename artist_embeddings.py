...
if __name__ == '__main__':
    ...
    model = None
    if os.path.isfile("models/gensim_word2vec/1_mil_playlists_artists/word2vec-artist-vectors.model"):
        print("load model from file")
        model = gensim.models.Word2Vec.load("./models/gensim_word2vec/1_mil_playlists_artists/word2vec-artist-vectors.model")
        ...
        # save model
        model.save("./models/gensim_word2vec/1_mil_playlists_artists/word2vec-artist-vectors.model")
